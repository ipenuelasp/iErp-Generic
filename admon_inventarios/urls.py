...
urlpatterns = [
    ...
    path('catalogos/plantilla/', views.DescargarPlantillaCatalogosView.as_view(), name='plantilla_catalogos'),
    path('catalogos/importar/', views.ImportarCatalogosView.as_view(), name='importar_catalogos'),
